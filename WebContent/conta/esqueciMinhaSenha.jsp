...
<body>
	...
	<main>
		<div class="container">
			...
			<form method="post" class="js-pristine-validation">
				<div class="form-group">
					<input type="email" name="email" placeholder="Insira seu e-mail para recuperar a senha" required data-pristine-required-message="Este campo é obrigatório" data-pristine-email-message="Este campo precisa ser um e-mail válido">
				</div>
