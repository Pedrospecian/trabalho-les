...
<body>
	...
	<main class="main-default">
		<div class="container">
			<h1>Cadastro de grupo de precificação</h1>
			<form action="/trabalho-les/cadastroGrupoPrecificacaoAction" class="js-pristine-validation">
				...
				<div class="form-group">
					<input type="number" name="porcentagem" placeholder="Porcentagem de Lucro" min="0" step="0.01" required data-pristine-required-message="Este campo é obrigatório" pattern="/^[0-9]+((\.|,)[0-9]+)?$/" data-pristine-pattern-message="Este campo precisa ser um número válido" cypress-porcentagem>
				</div>
				<div class="form-group">
