...
<head>
	<meta charset="utf-8">
	<title>Alterar senha de ${usuario.getNome()}</title>
...
<body>
	...
	<main>
		<div class="container">
			<h1>Alterar senha de ${usuario.getNome()}</h1>
			<form action="/trabalho-les/alterarSenhaUsuarioAdminAction" method="post" class="js-pristine-validation">
				<input type="hidden" name="id" value="${usuario.getId()}">
				<div class="form-group">
					<input type="password" name="senhaAtual" placeholder="Digite sua senha atual" required data-pristine-required-message="Este campo é obrigatório" cypress-senhaAtual>
				</div>
				<div class="form-group">
